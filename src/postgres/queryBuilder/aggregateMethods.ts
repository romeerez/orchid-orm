...
export class AggregateMethods {
  ...
  avg<T extends Base>(this: T, arg: NumberExpression<T>, options?: AggregateOptions) {
    return this.clone()._avg(arg, options)
  }

  _avg<T extends Base>(this: T, arg: NumberExpression<T>, options?: AggregateOptions) {
  ...
  sum<T extends Base>(this: T, arg: NumberExpression<T>, options?: AggregateOptions) {
    return this.clone()._sum(arg, options)
  }

  _sum<T extends Base>(this: T, arg: NumberExpression<T>, options?: AggregateOptions) {
  ...
  bitAnd<T extends Base>(this: T, arg: NumberExpression<T>, options?: AggregateOptions) {
    return this.clone()._bitAnd(arg, options)
  }

  _bitAnd<T extends Base>(this: T, arg: NumberExpression<T>, options?: AggregateOptions) {
    return selectAggregate(this, 'bit_and', arg, options)._value<T, number>()
  }

  bitOr<T extends Base>(this: T, arg: NumberExpression<T>, options?: AggregateOptions) {
    return this.clone()._bitOr(arg, options)
  }

  _bitOr<T extends Base>(this: T, arg: NumberExpression<T>, options?: AggregateOptions) {
    return selectAggregate(this, 'bit_or', arg, options)._value<T, number>()
  }

  boolAnd<T extends Base>(this: T, arg: BooleanExpression<T>, options?: AggregateOptions) {
    return this.clone()._boolAnd(arg, options)
  }

  _boolAnd<T extends Base>(this: T, arg: BooleanExpression<T>, options?: AggregateOptions) {
    return selectAggregate(this, 'bool_and', arg, options)._value<T, boolean>()
  }

  boolOr<T extends Base>(this: T, arg: BooleanExpression<T>, options?: AggregateOptions) {
    return this.clone()._boolOr(arg, options)
  }

  _boolOr<T extends Base>(this: T, arg: BooleanExpression<T>, options?: AggregateOptions) {
    return selectAggregate(this, 'bool_or', arg, options)._value<T, boolean>()
  }

  every<T extends Base>(this: T, arg: BooleanExpression<T>, options?: AggregateOptions) {
    return this.clone()._every(arg, options)
  }

  _every<T extends Base>(this: T, arg: BooleanExpression<T>, options?: AggregateOptions) {
