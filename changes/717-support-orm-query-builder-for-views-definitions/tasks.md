...
- [x] 1.1 Expose a stable query-definition SQL shape for ORM consumers
...
- [x] 2.1 Add the regular view `query` definition property
...
- [x] 2.2 Capture final view query after `init(db)`
...
- [x] 2.3 Normalize view query definitions for generated migrations
...
- [x] 3.1 Document query-built regular view definitions
