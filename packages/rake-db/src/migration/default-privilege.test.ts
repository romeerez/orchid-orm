...
ALTER DEFAULT PRIVILEGES IN SCHEMA "some_schema" REVOKE ALL PRIVILEGES ON TYPES FROM "some_role"`,
  ...
  it('should generate SQL for global default privileges (no schema)', async () => {
    const testUpAndDown = makeTestUpAndDown('changeDefaultPrivileges');
    ...
    await testUpAndDown(
      ...
      () =>
        expectSql(
          'ALTER DEFAULT PRIVILEGES GRANT SELECT ON TABLES TO "some_role"',
        ),
      () =>
        expectSql(
          'ALTER DEFAULT PRIVILEGES REVOKE SELECT ON TABLES FROM "some_role"',
        ),
    );
  });

  it('should generate SQL for SCHEMAS', async () => {
    const testUpAndDown = makeTestUpAndDown('changeDefaultPrivileges');
    ...
    await testUpAndDown(
      ...
      () =>
        expectSql(
          'ALTER DEFAULT PRIVILEGES GRANT USAGE, CREATE ON SCHEMAS TO "some_role"',
        ),
      () =>
        expectSql(
          'ALTER DEFAULT PRIVILEGES REVOKE USAGE, CREATE ON SCHEMAS FROM "some_role"',
        ),
    );
  });

  it('should generate SQL for LARGE OBJECTS', async () => {
    const testUpAndDown = makeTestUpAndDown('changeDefaultPrivileges');
    ...
    await testUpAndDown(
      ...
      () =>
        expectSql(
          'ALTER DEFAULT PRIVILEGES GRANT SELECT, UPDATE ON LARGE OBJECTS TO "some_role"',
        ),
      () =>
        expectSql(
          'ALTER DEFAULT PRIVILEGES REVOKE SELECT, UPDATE ON LARGE OBJECTS FROM "some_role"',
        ),
    );
  });

  it('should expand all to all object types including SCHEMAS and LARGE OBJECTS when no schema provided', async () => {
    const testUpAndDown = makeTestUpAndDown('changeDefaultPrivileges');
    ...
    await testUpAndDown(
      ...
      () =>
        expectSql(
          `ALTER DEFAULT PRIVILEGES FOR ROLE "admin" GRANT ALL PRIVILEGES ON TABLES TO "app_user";
ALTER DEFAULT PRIVILEGES FOR ROLE "admin" GRANT ALL PRIVILEGES ON SEQUENCES TO "app_user";
ALTER DEFAULT PRIVILEGES FOR ROLE "admin" GRANT ALL PRIVILEGES ON FUNCTIONS TO "app_user";
ALTER DEFAULT PRIVILEGES FOR ROLE "admin" GRANT ALL PRIVILEGES ON TYPES TO "app_user";
ALTER DEFAULT PRIVILEGES FOR ROLE "admin" GRANT ALL PRIVILEGES ON SCHEMAS TO "app_user";
ALTER DEFAULT PRIVILEGES FOR ROLE "admin" GRANT ALL PRIVILEGES ON LARGE OBJECTS TO "app_user"`,
        ),
      () =>
        expectSql(
          `ALTER DEFAULT PRIVILEGES FOR ROLE "admin" REVOKE ALL PRIVILEGES ON TABLES FROM "app_user";
ALTER DEFAULT PRIVILEGES FOR ROLE "admin" REVOKE ALL PRIVILEGES ON SEQUENCES FROM "app_user";
ALTER DEFAULT PRIVILEGES FOR ROLE "admin" REVOKE ALL PRIVILEGES ON FUNCTIONS FROM "app_user";
ALTER DEFAULT PRIVILEGES FOR ROLE "admin" REVOKE ALL PRIVILEGES ON TYPES FROM "app_user";
ALTER DEFAULT PRIVILEGES FOR ROLE "admin" REVOKE ALL PRIVILEGES ON SCHEMAS FROM "app_user";
ALTER DEFAULT PRIVILEGES FOR ROLE "admin" REVOKE ALL PRIVILEGES ON LARGE OBJECTS FROM "app_user"`,
        ),
    );
  });
});
