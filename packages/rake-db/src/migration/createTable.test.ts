          ...
          expectSql([
            `
              CREATE TABLE "table" (
                ...
                "title" text NOT NULL,
                "text" text NOT NULL,
                "generated" tsvector GENERATED ALWAYS AS (setweight(to_tsvector(coalesce("title", '')), 'A') || setweight(to_tsvector(coalesce("text", '')), 'B')) STORED NOT NULL
              )
            `,
            `
              CREATE INDEX "table_generated_idx" ON "table" USING GIN ("generated")
