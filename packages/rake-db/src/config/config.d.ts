import { Adapter, ColumnSchemaConfig, DbResult, DefaultColumnTypes, DefaultSchemaConfig, MaybePromise, NoPrimaryKeyOption, QueryLogOptions, RecordString } from 'pqb/internal';
import { MigrationItem } from '../migration/migrations-set';
export type SearchPath = (() => string) | string;
export interface RakeDbCliConfigInputBase<SchemaConfig extends ColumnSchemaConfig, CT = DefaultColumnTypes<DefaultSchemaConfig>> extends QueryLogOptions {
...
export type RakeDbCliConfigInput<SchemaConfig extends ColumnSchemaConfig, CT = DefaultColumnTypes<DefaultSchemaConfig>> = RakeDbCliConfigInputFileBased<SchemaConfig, CT> | RakeDbCliConfigInputCodeBased<SchemaConfig, CT>;
...
export declare const rakeDbConfigDefaults: {
    migrationId: {
        serial: number;
    };
    migrationsTable: string;
...
export interface RakeDbDefineTable<CT> {
    /**
...
export interface RakeDbTableFactoryConfig<CT> {
    /**
     * Export name configured for this table factory.
     */
    exportAs: string;
...
export type RakeDbMigrationId = 'timestamp' | {
    serial: number;
};
