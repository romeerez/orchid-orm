...
describe('dbStructure', () => {
  ...
  describe('defaultPrivileges', () => {
    ...
    it('should filter out global privileges without schema', async () => {
      mockQueryResult({
        defaultPrivileges: [
          defaultPrivilege({
            schema: undefined,
    ...
    it('should filter out schema and large_object object types', async () => {
      mockQueryResult({
        defaultPrivileges: [
          defaultPrivilege({
            object: 'schema',
    ...
    it('should group multiple object types by grantor, grantee, and schema', async () => {
      mockQueryResult({
        defaultPrivileges: [
          defaultPrivilege({
            object: 'relation',
    ...
    it('should create separate entries for different grantor, grantee, or schema', async () => {
      mockQueryResult({
        defaultPrivileges: [
          defaultPrivilege({
            grantor: 'postgres',
