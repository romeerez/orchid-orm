...
describe('operators', () => {
  ...
  describe('equals', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ name: { equals: testDb.raw("'name'") } }).toSql(),
        `
          SELECT * FROM "user"
  ...
  describe('not', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ name: { not: testDb.raw("'name'") } }).toSql(),
        `
          SELECT * FROM "user"
          WHERE "user"."name" <> 'name'
        `,
  ...
  describe('in', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ name: { in: testDb.raw("('a', 'b')") } }).toSql(),
        `
          SELECT * FROM "user"
  ...
  describe('notIn', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ name: { notIn: testDb.raw("('a', 'b')") } }).toSql(),
        `
          SELECT * FROM "user"
  ...
  describe('lt', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ id: { lt: testDb.raw('5') } }).toSql(),
        `
          SELECT * FROM "user"
          WHERE "user"."id" < 5
        `,
  ...
  describe('lte', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ id: { lte: testDb.raw('5') } }).toSql(),
        `
          SELECT * FROM "user"
          WHERE "user"."id" <= 5
        `,
  ...
  describe('gt', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ id: { gt: testDb.raw('5') } }).toSql(),
        `
          SELECT * FROM "user"
          WHERE "user"."id" > 5
        `,
  ...
  describe('gte', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ id: { gte: testDb.raw('5') } }).toSql(),
        `
          SELECT * FROM "user"
          WHERE "user"."id" >= 5
        `,
  ...
  describe('contains', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ name: { contains: testDb.raw("'ko'") } }).toSql(),
        `
          SELECT * FROM "user"
  ...
  describe('containsSensitive', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ name: { containsSensitive: testDb.raw("'ko'") } }).toSql(),
        `
          SELECT * FROM "user"
  ...
  describe('startsWith', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ name: { startsWith: testDb.raw("'ko'") } }).toSql(),
        `
          SELECT * FROM "user"
          WHERE "user"."name" ILIKE 'ko' || '%'
        `,
  ...
  describe('startsWithSensitive', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({
          name: { startsWithSensitive: testDb.raw("'ko'") },
        }).toSql(),
        `
          SELECT * FROM "user"
          WHERE "user"."name" LIKE 'ko' || '%'
  ...
  describe('endsWith', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ name: { endsWith: testDb.raw("'ko'") } }).toSql(),
        `
          SELECT * FROM "user"
          WHERE "user"."name" ILIKE '%' || 'ko'
        `,
  ...
  describe('endsWithSensitive', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({ name: { endsWithSensitive: testDb.raw("'ko'") } }).toSql(),
        `
          SELECT * FROM "user"
          WHERE "user"."name" LIKE '%' || 'ko'
        `,
  ...
  describe('between', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({
          id: { between: [testDb.raw('1'), testDb.raw('10')] },
        }).toSql(),
        `
          SELECT * FROM "user"
  ...
  describe('jsonPath', () => {
    ...
    it('should handle raw query', () => {
      expectSql(
        User.where({
          data: { jsonPath: ['$.name', '=', testDb.raw("'name'")] },
        }).toSql(),
        `
          SELECT * FROM "user"
