...
export type ColumnSchemaGetterColumns<T extends ColumnSchemaGetterTableClass> = T['prototype']['columns']['shape'];
...
export interface ColumnSchemaConfig<T extends Column.Pick.Data = Column.Pick.Data> extends ColumnTypeSchemaArg {
