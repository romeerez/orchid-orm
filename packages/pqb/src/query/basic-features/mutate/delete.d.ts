import { SetQueryReturnsRowCount, SetQueryReturnsRowCountMany, Query } from '../../query';
import { PickQueryHasSelectResultReturnType, PickQueryHasWhere, PickQueryHasSelectHasWhereResultReturnType } from '../../pick-query-types';
import { EmptyTuple } from '../../../utils';
export type DeleteMethodsNames = 'delete';
export type DeleteArgs<T extends PickQueryHasWhere> = T['__hasWhere'] extends true ? EmptyTuple : [never];
export type DeleteResult<T extends PickQueryHasSelectResultReturnType> = T['__hasSelect'] extends true ? T : T['returnType'] extends undefined | 'all' ? SetQueryReturnsRowCountMany<T> : SetQueryReturnsRowCount<T>;
export interface DeleteSelf extends PickQueryHasSelectHasWhereResultReturnType, Query.Pick.IsNotReadOnly {
}
export declare const _queryDelete: <T extends PickQueryHasSelectResultReturnType>(query: T) => DeleteResult<T>;
export declare class QueryDelete {
    /**
