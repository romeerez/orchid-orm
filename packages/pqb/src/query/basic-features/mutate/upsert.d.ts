import { Query, SetQueryReturnsOne, SetQueryReturnsVoid, SetValueQueryReturnsValueOrThrow } from '../../query';
import { UpdateData, UpdateSelf } from './update';
...
export type UpsertResult<T extends PickQueryHasSelectResultReturnType> = T['__hasSelect'] extends true ? T['returnType'] extends 'value' | 'valueOrThrow' ? SetValueQueryReturnsValueOrThrow<T> : SetQueryReturnsOne<T> : SetQueryReturnsVoid<T>;
...
export declare const _queryUpsert: (q: Query, data: UpsertData<UpsertThis, UpdateData<UpdateSelf>>) => Query;
export declare class QueryUpsert {
    /**
