import { GetArg, GetResult, GetResultOptional, QueryGetSelf } from './get.utils';
export declare class QueryGet {
    /**
     ...
     */
    get<T extends QueryGetSelf, Arg extends GetArg<T>>(this: T, arg: Arg): GetResult<T, Arg>;
    /**
