import { IsQuery, Query, QueryHasSelect, QueryOrExpressionBooleanOrNullResult, QueryTake, QueryTakeOptional } from '../../query';
import { JoinArgs, JoinCallback, JoinCallbackArgs, JoinFirstArg } from '../join/join';
import { PickQuerySelectableShapeRelationsWithDataAs, PickQueryRelations, PickQuerySelectableRelations, PickQuerySelectableRelationsResultReturnType } from '../../pick-query-types';
...
export type WhereArg<T extends PickQuerySelectableRelations> = {
    ...
    }> : T['__selectable'][K]['column']['__queryType'] | null | {
 ...
 * ```
 */
export type WhereQueryBuilder<T extends PickQueryRelations> = EmptyObject extends T['relations'] ? {
...
export type WhereInColumn<T extends PickQuerySelectableRelations> = keyof T['__selectable'] | [keyof T['__selectable'], ...(keyof T['__selectable'])[]];
export type WhereInValues<T extends PickQuerySelectableRelations, Column> = Column extends keyof T['__selectable'] ? Iterable<T['__selectable'][Column]['column']['__queryType']> | IsQuery | Expression : ({
    [I in keyof Column]: Column[I] extends keyof T['__selectable'] ? T['__selectable'][Column[I]]['column']['__queryType'] : never;
} & {
...
export type WhereInArg<T extends PickQuerySelectableRelations> = {
    [K in keyof T['__selectable']]?: Iterable<T['__selectable'][K]['column']['__queryType']> | IsQuery | Expression;
};
 ...
 */
export declare const _queryWhere: <T extends PickQuerySelectableRelations>(q: T, args: WhereArgs<T>) => T & QueryHasWhere;
export declare const _queryFindBy: <T extends PickQuerySelectableRelationsResultReturnType>(q: T, arg: WhereArg<T>) => QueryTake<T & QueryHasWhere>;
export declare const _queryFindByOptional: <T extends PickQuerySelectableRelationsResultReturnType>(q: T, arg: WhereArg<T>) => QueryTakeOptional<T & QueryHasWhere>;
/**
 * Mutative {@link Where.prototype.whereSql}
 */
export declare const _queryWhereSql: <T>(q: T, args: SQLQueryArgs) => T;
/**
 * Mutative {@link Where.prototype.whereNot}
 */
export declare const _queryWhereNot: <T extends PickQuerySelectableRelations>(q: T, args: WhereNotArgs<T>) => T & QueryHasWhere;
/**
 * Mutative {@link Where.prototype.whereNotSql}
 */
export declare const _queryWhereNotSql: <T>(q: T, args: SQLQueryArgs) => T;
/**
 * Mutative {@link Where.prototype.whereNotExists}
 */
export declare const _queryWhereNotExists: (q: Query, arg: unknown, args: unknown) => never;
export declare const _queryWhereOneOf: <T extends PickQuerySelectableRelations>(q: T, args: WhereArgs<T>) => T & QueryHasWhere;
export declare const _queryWhereNotOneOf: <T extends PickQuerySelectableRelations>(q: T, args: WhereArgs<T>) => T;
/**
 * Mutative {@link Where.prototype.orWhere}
 */
export declare const _queryOr: <T extends PickQuerySelectableRelations>(q: T, args: WhereArgs<T>) => T & QueryHasWhere;
/**
 * Mutative {@link Where.prototype.orWhereNot}
 */
export declare const _queryOrNot: <T extends PickQuerySelectableRelations>(q: T, args: WhereArgs<T>) => T & QueryHasWhere;
/**
 * Mutative {@link Where.prototype.whereIn}
 */
export declare const _queryWhereIn: <T>(q: T, and: boolean, arg: unknown, values: unknown[] | Iterable<unknown> | IsQuery | Expression | undefined, not?: boolean) => T & QueryHasWhere;
/**
 * Mutative {@link Where.prototype.whereExists}
 */
export declare const _queryWhereExists: <T extends PickQuerySelectableShapeRelationsWithDataAs, Arg extends JoinFirstArg<T>>(q: T, arg: Arg, args: [JoinCallback<T, Arg>] | JoinArgs<T, Arg>) => T & QueryHasWhere;
