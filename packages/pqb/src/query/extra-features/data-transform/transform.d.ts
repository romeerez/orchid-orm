...
export type QueryDataTransform = QueryDataTransformFn | {
 ...
 */
export declare const applyTransforms: (queryData: unknown, returnType: QueryReturnType, fns: QueryDataTransform[], result: unknown) => unknown;
export declare const applyBatchTransforms: (q: QueryData, batches: QueryBatchResult[]) => void;
export declare class QueryTransform {
    /**
