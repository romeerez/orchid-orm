 ...
 **/
export type SetQueryReturnsColumnInfo<T extends PickQueryShape, Column extends keyof T['shape'] | undefined, Result = Column extends keyof T['shape'] ? GetColumnInfo : {
 ...
 */
export declare function getColumnInfo<T extends PickQueryShape, Column extends keyof T['shape'] | undefined = undefined>(query: T, column?: Column): SetQueryReturnsColumnInfo<T, Column>;
